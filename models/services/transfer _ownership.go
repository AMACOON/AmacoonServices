...
type CatTransferOwnershipDB struct {
    gorm.Model
...
func (c *CatTransferOwnershipDB) TableName() string {
...
type CatTransferOwnerShip struct {
    ID uint
	Cat    CatTransOwner
    Seller SellerTransOwner
    Buyer  BuyerTransOwner
}
